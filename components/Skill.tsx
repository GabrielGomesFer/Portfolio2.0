...
export default function Skill({ directionLeft, imgLink, percent }: Props) {
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        src={imgLink}
        className="rounded-lg border border-gray-500 object-cover w-24 h-24 xl:w-32 xl:h-32 filter group-hover:grayscale transition duration-300 ease-in-out"
      />
